...
const long interval = 5000; // Sample and send every 500 ms
...
void setup() {
  ...
  Serial.println("--- IMU READINGS & I2C MASTER READY ---");
}
...
void loop() {
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    // Print values locally to Serial Monitor
    Serial.print("ACC [g]: "); Serial.print(ax); Serial.print(", "); Serial.print(ay); Serial.print(", "); Serial.println(az);
    Serial.print("GYR [dps]: "); Serial.print(gx); Serial.print(", "); Serial.print(gy); Serial.print(", "); Serial.println(gz);
    Serial.print("MAG [uT]: "); Serial.print(mx); Serial.print(", "); Serial.print(my); Serial.print(", "); Serial.println(mz);
    Serial.println("-------------------------------------");

    // Send primary Accelerometer value (X-axis) formatted via I2C to Slave
    char payload[16];
    snprintf(payload, sizeof(payload), "AX:%.2f", ax);
